...
void PlayScene::Init()
{
    ...
    m_registry->AddComponent<TransformComponent>(player, FVector3(1.5f, 0.8f, -20.0f), FVector3(0.2f, 0.2f, 0.2f),
                                                 FVector3(1.0f, 0.4f, 0.8f));
    ...
    m_registry->AddComponent<TransformComponent>(cube, FVector3(-1.5f, -0.8f, -20.0f), FVector3(0.2f, 0.5f, 3.0f),
                                                 FVector3(0.4f, 0.7f, 1.0f));
